...
var $author$project$Homepage$createPath = F2(
	function (n, shouldAnimate) {
		return A2(
			$elm$svg$Svg$path,
			_List_fromArray(
				[
					...
					$author$project$Homepage$setAnimation(shouldAnimate))
				]),
			_List_Nil);
	});
...
var $author$project$Homepage$svg_main = F2(
	function (filenames, shouldAnimate) {
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $author$project$Main$firstUpper = function (str) {
	var _v0 = $elm$core$String$uncons(str);
	if (_v0.$ === 'Just') {
		var _v1 = _v0.a;
		var c = _v1.a;
...
var $author$project$Main$toTitleCase = function (str) {
	return A2(
		$elm$core$String$join,
		' ',
		A2(
			$elm$core$List$map,
			$author$project$Main$firstUpper,
			$elm$core$String$words(str)));
};
var $author$project$Main$rowDiv = F2(
	function (classname, csv) {
		return A4(
			$author$project$Main$classDiv,
			classname,
			$author$project$Main$toTitleCase(csv.book_title),
			A2(
				$elm$core$String$join,
				', ',
				A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$cons,
						A4($author$project$Main$classDiv, 'header', 'Book Title', 'Book Info', 'Date Finished'),
